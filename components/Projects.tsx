      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project) => (
            <div
              key={project.title}
              className="rounded-xl overflow-hidden border border-foreground/10 hover:border-foreground/30 transition-colors bg-foreground/[0.03]"
            >
              <div className="aspect-video bg-foreground/10">
                {/* Substitua por <img> ou next/image quando tiver os prints */}
              </div>
