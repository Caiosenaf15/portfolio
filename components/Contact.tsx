        ...
        <FadeIn>
            <div className="max-w-2xl mx-auto text-center">
                ...
                <a
                    ...
                    className="bg-accent text-white px-6 py-3 rounded-lg font-medium hover:scale-105 transition-transform"
                >
                    Enviar Email
                </a>
                <a
                    ...
                    className="border border-foreground/20 px-6 py-3 rounded-lg font-medium hover:bg-foreground/5 hover:scale-105 transition-transform"
                >
                    LinkedIn
                </a>
                <a
